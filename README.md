...
- └── **00-projects**/ ← shopping list, lunch picker, golf score, card counter, leap year, wildlife tracker

## What This Repo Contains

- **Concept notes** — written in my own words as I learn them
- **Code experiments** — testing syntax, methods, and logic
- **FreeCodeCamp labs** — exercises and recreations from the curriculum
...
- [GitHub](https://github.com/harrylibrando06-byte)
